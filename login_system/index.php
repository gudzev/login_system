        ...
        <div class="card shadow-2-strong card-registration square-card mx-auto p-3 p-md-5" style="border-radius: 15px;">
          <div class="card-body">
            ...
            <form action="login_user.php" method="post" enctype="multipart/form-data">
              ...
              <button class="btn btn-success w-100 mb-3 fs-4">Login</button>


              <div class="fs-5">
                <div>Don't have an account? <a href="register.php" class="link">Sign up</a></div>
              </div>
